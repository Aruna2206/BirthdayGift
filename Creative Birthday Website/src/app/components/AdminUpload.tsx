    ...
    <div className="min-h-screen p-8 bg-pink-50 flex flex-col items-center justify-center">
      ...
      >
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-pink-600">Admin Upload</h1>
          <button onClick={onLogout} className="text-pink-500 hover:text-pink-700 font-semibold">Logout</button>
        </div>
        ...
        <form onSubmit={handleUpload} className="space-y-6">
          ...
          <div className="flex gap-6">
            <label className="flex items-center gap-2 cursor-pointer group">
              ...
              />
              <span className="text-sm font-semibold text-gray-700 group-hover:text-pink-600 transition-colors">Mark as Favorite ❤️</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer group">
              <input 
                type="checkbox" 
              ...
              />
              <span className="text-sm font-semibold text-gray-700 group-hover:text-rose-600 transition-colors">Mark as Special ⭐</span>
            </label>
          </div>

          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Image Files *</label>
            <div className="border-2 border-dashed border-pink-300 rounded-xl p-6 flex flex-col items-center justify-center bg-pink-50/50 hover:bg-pink-50 transition-colors">
              <input 
          ...
          <button
            ...
            className="w-full bg-pink-500 text-white font-bold py-4 rounded-xl hover:bg-pink-600 shadow-lg disabled:opacity-50"
          >
