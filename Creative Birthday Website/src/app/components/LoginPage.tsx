...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const errorMessages = [
    "Invalid credentials. Think properly Mama why you are doing this.",
    "Come on Mama, I know you can remember the key!",
    "Oops! Wrong password. Think harder,Mama.",
    "Not quite right. Put some thought into it,Mama!",
    "Access denied! Don't let me down,Mama!",
    "Are you reallyMama? Try again!"
  ];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-400 via-rose-400 to-red-400 relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        >
          <Heart size={600} fill="currentColor" className="text-pink-200" />
        </motion.div>
      </div>
      ...
      >
        <div className="w-full h-4/5 bg-gradient-to-br from-pink-100 to-rose-100 rounded-md overflow-hidden flex items-center justify-center">
          <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ repeat: Infinity, duration: 2 }}>
            <Heart size={60} className="text-pink-400" fill="currentColor" />
          </motion.div>
        </div>
      ...
      <motion.div
        ...
        className="absolute w-56 h-64 bg-white/90 backdrop-blur-sm rounded-xl shadow-xl p-3 z-0 border border-white/50 hidden md:block"
      >
        <div className="w-full h-4/5 bg-gradient-to-br from-rose-100 to-red-100 rounded-md overflow-hidden flex items-center justify-center">
          <motion.div animate={{ rotate: [0, 10, -10, 0] }} transition={{ repeat: Infinity, duration: 3 }}>
            <PartyPopper size={60} className="text-rose-400" />
          </motion.div>
        </div>
        <p className="text-center mt-3 text-rose-500 font-bold tracking-wide">Best Day Ever!</p>
      </motion.div>
      ...
      >
        ...
        >
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-pink-500 to-red-500 rounded-full blur-xl opacity-50 group-hover/card:bg-gradient-to-br group-hover/card:from-rose-400 group-hover/card:to-pink-600 transition-colors" />
            <div className="relative flex items-center justify-center bg-gradient-to-br from-pink-500 via-rose-500 to-red-500 p-3 rounded-full shadow-xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center pt-1 pr-[1px]">
                  <Lock className="text-rose-500 group-hover/card:scale-110 transition-transform duration-300" size={18} fill="currentColor" />
              </div>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <h1 className="text-4xl font-bold text-center mb-2 bg-gradient-to-r from-pink-600 via-rose-600 to-red-600 bg-clip-text text-transparent">
            Our Love Portal
          </h1>
        ...
        >
          <div>
            ...
            <motion.div whileTap={{ scale: 0.98 }} className="relative group">
              <div className="absolute inset-0 bg-pink-400 rounded-2xl blur opacity-0 group-focus-within:opacity-30 transition-opacity duration-300" />
              <input
                type="text"
                value={username}
          ...
          {error && (
            <motion.div
              ...
              className="bg-red-100 border-2 border-red-400 text-red-700 px-5 py-4 rounded-2xl text-sm font-medium"
            >
              {error}
            </motion.div>
          )}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            type="submit"
            className="w-full bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 text-white py-4 rounded-2xl font-bold text-base shadow-xl hover:shadow-2xl transition-all flex items-center justify-center gap-2 relative overflow-hidden group"
          >
            <motion.div
        ...
        {/* <motion.div
          ...
          className="mt-6 p-3 bg-gradient-to-r from-pink-100 to-purple-100 rounded-xl border-2 border-pink-200"
        >
          <p className="text-center text-sm text-gray-600">
            💡 <span className="font-semibold">Hint:</span> username{' '}
            <span className="font-bold text-pink-600">"mylove"</span> & password{' '}
            <span className="font-bold text-pink-600">"forever"</span>
          </p>
        </motion.div> */}
      </motion.div>
    </div>
