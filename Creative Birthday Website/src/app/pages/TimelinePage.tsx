    ...
    return (
        <div className="container mx-auto px-6 py-12">
            ...
            <div className="max-w-6xl mx-auto relative">
                {/* Timeline line */}
                <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-pink-500 via-purple-500 to-red-500" />
        ...
        className="mt-20 bg-gradient-to-r from-pink-500 to-purple-500 rounded-3xl p-10 text-white text-center shadow-2xl"
      >
