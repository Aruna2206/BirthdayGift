...
export function SpecialPage() {
  ...
  const wishes = [
    { icon: Star, text: 'May all your dreams come true', color: 'from-yellow-400 to-orange-400' },
    { icon: Heart, text: 'Endless love and happiness', color: 'from-pink-500 to-red-500' },
    { icon: Sparkles, text: 'A year full of magical moments', color: 'from-purple-500 to-pink-500' },
    { icon: Crown, text: 'Being treated like the royalty you are', color: 'from-yellow-500 to-yellow-600' },
    { icon: Zap, text: 'Exciting adventures and new experiences', color: 'from-blue-500 to-purple-500' },
    { icon: Gift, text: 'Surprises that make you smile', color: 'from-green-500 to-teal-500' },
  ];
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      >
        ...
        <h2 className="text-6xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent mb-4">
          You Are Special
        </h2>
      ...
      <motion.div
        ...
        className="mb-16"
      >
        <h3 className="text-4xl font-bold text-center mb-10 text-pink-600 flex items-center justify-center gap-3">
          <Camera size={40} />
          Our Favorite Moments Collection
        </h3>
        {loading ? (
          <div className="text-center py-10 animate-pulse text-pink-400">Loading your favorites...</div>
        ) : favorites.length === 0 ? (
              ...
              >
                <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl border-8 border-white bg-white transform rotate-1 group-hover:rotate-0 transition-transform">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-pink-500/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-4">
                    ...
                    {photo.category && (
                      <span className="text-pink-100/90 text-xs font-semibold">{photo.category}</span>
                    )}
                  </div>
                  <div className="absolute top-3 right-3">
                    <Heart className="text-rose-500 shadow-sm" fill="currentColor" size={24} />
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {reasons.map((reason, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-pink-50 to-purple-50 p-6 rounded-2xl shadow-lg border-2 border-pink-200 relative overflow-hidden group"
            >
              <motion.div
      ...
      <motion.div
        ...
        className="mb-16"
      >
        <h3 className="text-4xl font-bold text-center mb-10 text-pink-600">
          My Wishes For You 🎂
        </h3>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {wishes.map((wish, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-gradient-to-br ${wish.color} p-8 rounded-3xl shadow-xl text-white relative overflow-hidden`}
              >
                <motion.div
      ...
      >
        <div className="bg-gradient-to-br from-purple-500 to-pink-500 p-10 rounded-3xl shadow-2xl text-white">
          <motion.div
      ...
      >
        <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-red-500 p-12 rounded-3xl shadow-2xl text-white text-center relative overflow-hidden">
          <motion.div
