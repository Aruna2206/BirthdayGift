  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 relative overflow-hidden pb-12">
      ...
      <motion.div
        ...
        className="mb-12"
      >
        <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-pink-600 via-rose-600 to-red-600 bg-clip-text text-transparent drop-shadow-sm">
          Our Love Gallery 📸
        </h1>
        <p className="text-2xl text-pink-900/80 mb-8 font-medium">
          ...
          <div className="flex gap-2 bg-white/80 rounded-2xl p-1 shadow-sm border border-pink-50">
             <motion.button
              ...
              className={`p-3 rounded-lg transition-colors ${
                viewMode === 'masonry' ? 'bg-pink-500 text-white' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <LayoutGrid size={20} />
            </motion.button>
